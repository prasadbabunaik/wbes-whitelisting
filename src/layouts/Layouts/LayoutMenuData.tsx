...
const Navdata = () => {
  ...
  //         id: "cisoApproval",
  //         label: "CISO Approval",
  //         link: "/modules/approval/ciso",
  //         parentId: "approval",
  //       },
  //       {
  //         id: "socClearance",
  //         label: "SOC Clearance",
  //         link: "/modules/approval/soc",
  //         parentId: "approval",
  //       },
  //       {
  //         id: "itWhitelisting",
  //         label: "IT Execution",
  //         link: "/modules/approval/it",
  //         parentId: "approval",
  //       },
  //     ],
  //   },
      ...
      subItems: [
        {
          ...
          link: "/modules/admin/users",
          parentId: "admin",
        },
        {
          id: "logs",
          label: "Audit Logs",
          link: "/modules/admin/logs",
          parentId: "admin",
        },
        {
          id: "sop-workflow",
          label: "SOP",
          link: "/modules/admin/sop-workflow",
          parentId: "admin",
        },
        {
          id: "reports",
